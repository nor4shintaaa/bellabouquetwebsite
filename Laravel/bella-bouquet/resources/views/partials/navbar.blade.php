<nav class="navbar">
    <div class="container nav-content">
        <div class="nav-brand">
            <span class="brand-text">Bella<span>Bouquet</span></span>
        </div>
        ...
        <div class="nav-links">
            ...
            <button type="button" class="theme-toggle" id="darkModeToggle">
                <i id="themeToggleIcon" data-lucide="moon" style="width: 16px; height: 16px;"></i>
        ...
        <div style="position: relative;" id="profileContainer">
            @auth
                ...
                <div id="logoutDropdown" style="display: none; position: absolute; top: 110%; right: 0; background: var(--white); border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); width: 220px; z-index: 1000; border: 1px solid var(--slate-100); overflow: hidden;">
                    <a href="{{ route('profil') }}" style="display: flex; align-items: center; gap: 10px; padding: 14px 20px; color: var(--slate-600); text-decoration: none; font-size: 0.9rem; font-weight: 600; transition: background 0.2s;">
                        <i data-lucide="user" style="width: 16px;"></i> Pengaturan Profil
                    </a>

                    <a href="{{ route('preferensi.index') }}" style="display: flex; align-items: center; gap: 10px; padding: 14px 20px; color: var(--slate-600); text-decoration: none; font-size: 0.9rem; font-weight: 600; transition: background 0.2s;">
                        <i data-lucide="settings" style="width: 16px;"></i> Preferensi Tampilan
                    </a>

                    <hr style="border: 0; border-top: 1px solid var(--slate-100); margin: 0;">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (darkModeToggle) {
            darkModeToggle.addEventListener('click', function () {
                ...
                setCookie('bella_theme', newTheme, 30);
                applyTheme();
            });
        }
